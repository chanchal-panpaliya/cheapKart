...
//api
import { fetchAllHomeData ,addToCartHandler,addToWishlistHandler} from "../../../useEffect/useEffectCart";


const Home_ProductDetails = (props) =>{
   ...
   useEffect(()=>{
    fetchAllHomeData().then(function(result){
...
export default Home_ProductDetails;