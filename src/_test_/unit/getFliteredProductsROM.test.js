import {getFliteredProductsROM} from '../../my-web/pages/ProductList/utlities';
...
describe("testing get Flitered Products by RAM", () => {
  //get Flitered Products by RAM
  it("should get Flitered Products by RAM", () => {  
      ...
      if (_32GB) {
                  let newList = getdatalist.filter(
                  (item) => "32GB" === item.ROM
                  );

                  expectedState.push(...newList);
      }
      ...
      const state = getFliteredProductsROM(getdatalist,"Mobiles", _32GB ,_64GB , _128GB , _256GB )
